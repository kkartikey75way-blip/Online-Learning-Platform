...
export default function AssignmentPage({ moduleId }: { moduleId?: string }) {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto h-full overflow-y-auto bg-white">
      ...
      <div className="bg-white border-2 border-indigo-50 rounded-3xl p-8 shadow-xl shadow-indigo-500/5">
        ...
        {submission?.grade !== undefined && (
          <div className="mt-8 p-8 bg-gradient-to-br from-indigo-600 to-indigo-800 rounded-3xl text-white shadow-xl shadow-indigo-200">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-8">
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 text-center border border-white/20 min-w-[140px]">
                <p className="text-indigo-200 text-xs font-black uppercase tracking-widest mb-1">Final Grade</p>
                <p className="text-5xl font-black">{submission.grade}%</p>
              </div>
              <div className="flex-1">
                <p className="text-indigo-200 text-xs font-black uppercase tracking-widest mb-2 pl-1">Instructor Feedback</p>
                <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 italic text-indigo-50 leading-relaxed font-medium">
        ...
        {submission && submission.grade === undefined && submission.feedback && (
          <div className="mt-8 pt-8 border-t border-gray-100">
            <h4 className="font-bold text-gray-800 mb-3">Instructor Feedback</h4>
            <div className="bg-teal-50 text-teal-800 p-4 rounded-xl text-sm italic border border-teal-100">
              {submission.feedback}
            </div>
          </div>
        )}
